...
namespace ConcertTickets.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "Voornaam mag niet langer zijn dan 100 tekens.")]
            public string FirstName { get; set; }

            [Required(ErrorMessage = "Dit veld is verplicht.")]
            [Display(Name = "Familienaam")]
            [StringLength(100, ErrorMessage = "Familienaam mag niet langer zijn dan 100 tekens.")]
            public string LastName { get; set; }

            [Display(Name = "Lidkaartnummer")]
            [MemberCardNumberValidation("Lidkaartnummer is 13 karakters lang, begint met ODI en eindig met 10 cijfers.")]
            ...
            /// </summary>
            [Required(ErrorMessage = "Dit veld is verplicht.")]
            [EmailAddress(ErrorMessage = "Emailadres niet geldig.")]
